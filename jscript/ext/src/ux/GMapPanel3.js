...
markers: [{
        ...
        if (this.rendered){
          ...
          Ext.defer(function(){            
              ...
              if (!this.mapDefined && this.gmapType){
                ...
                google.maps.event.addListener(this.getMap(), 'click', Ext.Function.bind(this.onClick, this)); // Added by Fojo
    ...
    onResize : function(w, h){
     ...
     /**
     * Click handler Gfojo todo bien monic
     * @return {GMap} this
     */
    onClick : function(event){

        this.fireEvent('click', event.latLng,this.getMap());
