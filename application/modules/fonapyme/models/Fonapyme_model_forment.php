...
class fonapyme_model_forment extends CI_Model {
    ...
    function download_registros(){
        
        $result = array();
        $container = 'container.formentrada';
        $result = $this->db_formentrada->get($container)->result_array();
