                ...
                <form method='post'>
                    ...
                    <div class="row">
                        <div class='col-md-12'>
                            ...
                            <input type="text" class="form-control" id="dependencia" name="dependencia" value="SECRETARIA DE EMPRENDEDORES Y DE LA PEQUEÑA Y MEDIANA EMPRESA">
                        </div>
                    ...
                    <div class="row">
                        <div class='col-md-6'>
                            <label for="pasaje">Tramo/Pasaje</label>
                            <input type="text" class="form-control" id="pasaje" name="pasaje" placeholder="BUE-MI-BO-NY-BUE">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class='col-md-6'>
                            ...
                            <input type="text" class="form-control" id="seguro_medico" name="seguro_medico" placeholder="ANUAL">
                        </div>
                    </div>
