...
$.ajax({
  url: base_url+'gestion/viaticos/print_get_user_config',
  async:false,
  dataType:'json',
  method:'post',
    ...
    $('#calendar').fullCalendar({
        ...
        eventDrop: function( event, delta, revertFunc, jsEvent, ui, view ){
           ...
           // console.log(event);
            ...
            $.post(base_url+'gestion/viaticos/update_event',{'event':myevent},function(resp){
                console.log(resp);
            });
        ...
        eventClick: function(calEvent, jsEvent, view) {
            ...
            // alert('View: ' + view.name);
                ...
                $.post(base_url+'gestion/viaticos/get_event_by_id',{'id':myid},function(resp){
		...
		events: {
			url:  base_url+'gestion/viaticos/get_events',
			type: 'GET',
            data: function() { 
            var ret=$( "body" ).data();
            console.log('---'+ret);
...
$(document).on('click','#widget_groups .color_picker .dropdown-menu a',function(e){
   ...
   if(mycolor=='void'){
    ...
    $.post(base_url+'gestion/viaticos/groups_set_color',{'config':config},function(resp){
...
$.post(base_url+'gestion/viaticos/create_event_wrapper',{event:event},function(resp){
console.log(resp);
 if(resp==1)
    $('#calendar').fullCalendar('refetchEvents');
});
...
$('#myModal').on('click','#modal_delete',function(e){
    ...
    $.post(base_url+'gestion/viaticos/delete_event',{'id':myid},function(resp){
     if(resp==1)
        $('#calendar').fullCalendar('refetchEvents');
        $('#myModal').modal('hide');
    });
