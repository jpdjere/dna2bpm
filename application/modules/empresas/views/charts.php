    ...
    <div class="box-header" style="cursor: move;">
        ...
        <div class="col-lg-6 col-md-5 col-sm-4 col-xs-12">
            <div style="margin-top: 12px;" class="box-tools">
                <p style="font-size: 12px; padding-right: 5px; border-right: 1px solid #f4f4f4 " class="pull-left">
                    <i class="fa fa-circle-o referencia"></i> Cantidad
                </p>
            </div>
        </div>
    </div>
    <div class="box-body {class-tour}">
        <div style="height: 300px; padding: 0px; position: relative;" class="morris_line">
        </div>
    </div>
    <!-- /.box-body-->
</div>