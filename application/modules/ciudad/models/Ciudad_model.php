...
class ciudad_model extends CI_Model {
    ...
    function get_evaluator_by_project_by_id($query) {
        ...
        $rtn = array();
        $container = 'container.proyectos_ciudad';
    ...
    function get_cases_byFilter_container($idwf,$ident=195,$query){
     ...
     foreach($objs as $obj)
     $ids[]=$obj['id'];
     $filter=array('idwf'=>$idwf,'data.Proyectos_ciudad.query.id'=>array('$in'=>$ids));
