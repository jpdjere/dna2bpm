var latlong = {};
			latlong["AD"] = {"latitude":-31.866877, "longitude":-59.062832};
			latlong["AE"] = {"latitude":-32.015904, "longitude":-58.887867};
			latlong["AF"] = {"latitude":-29.067049, "longitude":-57.575633};
			
			latlong["AG"] = {"latitude":17.05, "longitude":-61.8};
			latlong["AI"] = {"latitude":18.25, "longitude":-63.1667};
			
			latlong["AL"] = {"latitude":-26.582367, "longitude":-54.163825};
			latlong["AM"] = {"latitude":-24.84196, "longitude":-60.025137};
			
			latlong["AN"] = {"latitude":12.25, "longitude":-68.75};
			
			latlong["AO"] = {"latitude":-25.160281, "longitude":-64.574215};
			
			latlong["AP"] = {"latitude":35, "longitude":105};
			
			latlong["AQ"] = {"latitude":-90, "longitude":0};
			
			latlong["AR"] = {"latitude":-36.724379, "longitude":-60.112619};
			
			latlong["AS"] = {"latitude":-14.3333, "longitude":-170};
			
			latlong["AT"] = {"latitude":47.3333, "longitude":13.3333};
			
			latlong["AU"] = {"latitude":-22.834168, "longitude":-65.798966};
			
			latlong["AW"] = {"latitude":12.5, "longitude":-69.9667};
			
			latlong["AZ"] = {"latitude":-26.503814, "longitude":-60.55003};
			
			latlong["BA"] = {"latitude":44, "longitude":18};
			
			latlong["BB"] = {"latitude":13.1667, "longitude":-59.5333};
			
			latlong["BD"] = {"latitude":-27.520772, "longitude":-63.349463};
			latlong["BE"] = {"latitude":-26.896039, "longitude":-65.18659};
			
			latlong["BF"] = {"latitude":-26.974322, "longitude":-67.198683};
			latlong["BG"] = {"latitude":-30.059922, "longitude":-60.899959};
			
			latlong["BH"] = {"latitude":-29.450077, "longitude":-67.023718};
			latlong["BI"] = {"latitude":-31.792274, "longitude":-63.699392};
			latlong["BJ"] = {"latitude":-33.712165, "longitude":-65.886449};
			
			latlong["BM"] = {"latitude":32.3333, "longitude":-64.75};
			
			latlong["BN"] = {"latitude":-30.967674, "longitude":-68.685881};
			latlong["BO"] = {"latitude":-37.215457, "longitude":-65.274073};
			
			latlong["BR"] = {"latitude":-34.511854, "longitude":-68.685881};
			
			latlong["BS"] = {"latitude":24.25, "longitude":-76};
			
			latlong["BT"] = {"latitude":-40.027551, "longitude":-66.761271};
			
			latlong["BV"] = {"latitude":-54.4333, "longitude":3.4};
			
			latlong["BW"] = {"latitude":-38.394824, "longitude":-69.735668};
			latlong["BY"] = {"latitude":-43.497523, "longitude":-68.598399};
			
			latlong["BZ"] = {"latitude":17.25, "longitude":-88.75};
			
			latlong["CA"] = {"latitude":-48.436396, "longitude":-69.735668};
			
			latlong["CC"] = {"latitude":-12.5, "longitude":96.8333};
			
			latlong["CD"] = {"latitude":-54.394435, "longitude":-67.811058};
		...
		var mapData = [
			{"code":"AF" , "name":"Corrientes", "value":32358260, "color":"#eea638"},
			{"code":"AL" , "name":"Misiones", "value":3215988, "color":"#d8854f"},
			{"code":"DZ" , "name":"Algeria", "value":35980193, "color":"#de4c4f"},
			{"code":"AO" , "name":"Salta", "value":19618432, "color":"#de4c4f"},
			{"code":"AR" , "name":"Buenos Aires", "value":40764561, "color":"#86a965"},
			{"code":"AM" , "name":"Formosa", "value":3100236, "color":"#d8854f"},
			{"code":"AU" , "name":"Jujuy", "value":22605732, "color":"#8aabb0"},
			{"code":"AT" , "name":"Austria", "value":8413429, "color":"#d8854f"},
			{"code":"AZ" , "name":"Chaco", "value":9306023, "color":"#d8854f"},
			{"code":"BH" , "name":"La Rioja", "value":1323535, "color":"#eea638"},
			{"code":"BD" , "name":"Santiago del Estero", "value":150493658, "color":"#eea638"},
			{"code":"BY" , "name":"Chubut", "value":9559441, "color":"#d8854f"},
			{"code":"BE" , "name":"Tucumán", "value":10754056, "color":"#d8854f"},
			{"code":"BJ" , "name":"San Luis", "value":9099922, "color":"#de4c4f"},
			{"code":"BT" , "name":"Río Negro", "value":738267, "color":"#eea638"},
			{"code":"BO" , "name":"La Pampa", "value":10088108, "color":"#86a965"},
			{"code":"BA" , "name":"Bosnia and Herzegovina", "value":3752228, "color":"#d8854f"},
			{"code":"BW" , "name":"Neuquén", "value":2030738, "color":"#de4c4f"},
			{"code":"BR" , "name":"Mendoza", "value":196655014, "color":"#86a965"},
			{"code":"BN" , "name":"San Juan", "value":405938, "color":"#eea638"},
			{"code":"BG" , "name":"Santa Fe", "value":7446135, "color":"#d8854f"},
			{"code":"BF" , "name":"Catamarca", "value":16967845, "color":"#de4c4f"},
			{"code":"BI" , "name":"Córdoba", "value":8575172, "color":"#de4c4f"},
			{"code":"KH" , "name":"Cambodia", "value":14305183, "color":"#eea638"},
			{"code":"CM" , "name":"Cameroon", "value":20030362, "color":"#de4c4f"},
			{"code":"CA" , "name":"Santa Cruz", "value":34349561, "color":"#a7a737"},
			...
			{"code":"CD" , "name":"Tierra del Fuego", "value":67757577, "color":"#de4c4f"},
			...
			{"code":"AE" , "name":"Entre Ríos", "value":7890924, "color":"#eea638"},
