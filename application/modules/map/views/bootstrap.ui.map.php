...
<!--        <script type="text/javascript" src="{module_url}assets/jscript/jquery.ui.map.v3/jquery.ui.map.js"></script>-->
        <script type="text/javascript" src="{module_url}assets/jscript/jquery.ui.map.v3/jquery.ui.map.full.min.js"></script>
