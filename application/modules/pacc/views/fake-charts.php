...
<div class="box-header" style="cursor: move;">
  ...
  <div class="col-lg-6 col-md-5 col-sm-4 col-xs-12">
        <div style="margin-top: 12px;" class="box-tools">
            <p style="font-size: 12px; padding-right: 3px;" class="pull-left"><i class="fa fa-circle-o referencia"></i> SDE Ingresada</p>
            <p style="font-size: 12px; padding-left: 3px; padding-right: 5px" class="pull-left"><i class="fa fa-circle-o referencia2"></i> SDE Evaluada</p>
            <p style="font-size: 12px; padding-left: 0px;" class="pull-left"><i class="fa fa-circle-o referencia3"></i> SDE No favorable</p>
        </div>
    </div>
    </div>
    <div class="box-body">
        <div style="height: 300px; padding: 0px; position: relative;" id="fake-chart">
