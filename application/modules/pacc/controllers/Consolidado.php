...
/**
 /**
* CONTROLADOR DASHBOARDS Consolidados
* 
...
class Consolidado extends MX_Controller {
    ...
    function Index() {
        $this->dashboard_consolidado();
    }
    /**
     * Dashboard del COORDINADOR DE EMPRESAS Y GRUPOS PRODUCTIVOS
     */
    function dashboard_consolidado() {
        Modules::run('dashboard/dashboard', 'pacc/json/dashboard_consolidado.json',true);
    }
    ...
    function tabla_prioridades() {
        ...
        return $this->parser->parse('pacc/consolidado/full-table', $data, true, true);
    }

    function half_table() {

        $this->load->module('dashboard');
        $this->load->module('pacc/consolidado/api');
        $template = "dashboard/widgets/box_info.php";
        $data = array();
        ...
        return $this->parser->parse('pacc/consolidado/half-table', $data, true, true);
    }
    ...
    function half_table_rank(){
        ...
        return $this->parser->parse('pacc/consolidado/half-table-rank',$data,true,true);
    } 
    ...
    function bars() {
        ...
        return $this->parser->parse('pacc/consolidado/bars', $data, true, true);
    }
    ...
    function charts() {
        ...
        return $this->parser->parse('pacc/consolidado/charts', $data, true, true);
    }
    ...
    function knobs_empresas() {
        ...
        return $this->parser->parse('pacc/consolidado/knobs-empresas', $data, true, true);
    }
    ...
    function knobs_emprendedores() {
        ...
        $data['base_url'] = $this->base_url;
        return $this->parser->parse('pacc/consolidado/knobs-emprendedores', $data, true, true);
    }
    ...
    function knobs_emprendedores_pitchs() {
        ...
        $data['title'] = "PITCHs";
        $data['base_url'] = $this->base_url;
        return $this->parser->parse('pacc/consolidado/knobs-pitchs', $data, true, true);
    }

    function data_table($data) {
        $this->load->model('pacc/consolidado/model_pacc');
    ...
    function area_charts() {
        ...
        $data['id'] = "sde_charts";
        $data['json_url'] = $this->base_url . 'pacc/consolidado/coordinador/sde_ultimos_28_dias';
