...
class Pagination extends MX_Controller {
    ...
    function Index($config) {
    	...
    	$customData['pagination'].="<li class='$class'><a href='$url' data-target='$ajax_target' class='$class_link'>$i</a></li>";
    	}
		...
		$customData ['pagination'] .= "<li class=''><a href='$url' data-target='$ajax_target' class='next $class_link'>&raquo;</a></li>";
	    $customData ['pagination'] .= "<li class=''><a>$items_total registros</a> </li>";
