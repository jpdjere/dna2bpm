...
function get_cat_agropecuario(){
    ...
    return $cat_agropecuario;
}

function get_cat_industria_mineria(){
    ...
    return $cat_industria_mineria;
}

function get_cat_comercio(){
...
function get_destino_prestamo_fona(){
    ...
    return $destino_prestamo_fona;
}

function get_sectores_proyecto(){
    ...
    return $sectores_proyecto;
}

function get_monto_prestamo_gran(){
    ...
    return $monto_prestamo_gran;
}

function get_monto_prestamo_bienes_cap(){
    $monto_prestamo_bienes_cap['0']='1.Hasta $3 millones';
    $monto_prestamo_bienes_cap['1']='2.Más de $3 millones';
    return $monto_prestamo_bienes_cap;
}

function get_monto_prestamo_inversion_prod(){
    $monto_prestamo_inversion_prod['0']='1.Hasta $1.5 millones';
    $monto_prestamo_inversion_prod['1']='2.Más de $1.5 millones';
    return $monto_prestamo_inversion_prod;
}

function get_monto_solicitado_otros(){
    $monto_prestamo_otros['0']='1. Hasta $1.5/$3 millones';
    $monto_prestamo_otros['1']='2. Más de $1.5/$3 millones';
    return $monto_prestamo_otros;
}

function get_destino_prestamo_gran(){
    ...
    return $destino_prestamo_gran;
}

function get_banco_rbt(){
    $banco_rbt['0']='BNA';
    $banco_rbt['1']='BICE';
    return $banco_rbt;
}

function get_banco_parques(){
    $banco_parques['0']='BNA';
    return $banco_parques;
}

function get_banco_mi_galpon(){
    $banco_mi_galpon['0']='BNA';
    return $banco_mi_galpon;
}

function get_todos_bancos(){
