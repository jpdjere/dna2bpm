...
//        var_dump(json_encode($filter),count($tokens));
        $data ['empresas'] = array_map(function ($token) {
            ...
            $url_clone = ''; 
            if ((in_array(584, $this->id_group) or in_array(586, $this->id_group) or in_array(1008, $this->id_group) or $this->user->isAdmin())
...
//        $renderData['text'] .=nl2br();
    ...
    function update_forms2($id) {
        ...
        */
        ...
        $result = $this->mysql_crefis_model->update_4970($id);        
        #print_r($result);
    }
