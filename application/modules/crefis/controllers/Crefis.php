...
//        $renderData['text'] .=nl2br();
    ...
    public function faq() {
        ...
        $config['body']="
            ...
            <li><a href='http://dna2.produccion.gob.ar/downloads/produccion/capacitacionPyme/anexo_1a_primertestimonioescritura.doc' target='_blank'><i class='fa fa-file-word-o'>Anexo para Presentaci&oacute;n de Proyectos (Anexo I A)</i></a></li>
            ...
            <li><a href='http://dna2.produccion.gob.ar/downloads/produccion/capacitacionPyme/modalidad_1.zip' target='_blank'><i class='fa fa-file-archive-o'></i>Anexo para Rendición de proyectos Modalidad 1 (Anexo I B y Anexo I C)</a></li>
 </ul>";
