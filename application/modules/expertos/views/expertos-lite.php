...
<div class = "col-md-3 load_tiles_after" data-id='mis_tramites' href='{base_url}/bpm/bpmui/widget_cases/1/5/carga_pro_inst' >
...
<div class = "col-md-3 load_tiles_after" data-id='mis_tareas' href='{base_url}/bpm/bpmui/widget_2doMe/1/5/carga_pro_inst'>
    <div class='row center-block dashboard_shortcut'>
...
<form action="{base_url}bpm/engine/newcase/model/carga_pro_inst">
<div class="modal fade" tabindex="-1" role="dialog" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Inscribite al Registro de Expertos!</h4>
      </div>
