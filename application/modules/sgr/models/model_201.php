...
class Model_201 extends CI_Model {
    ...
    function save($parameter) {
        ...
        $parameter['FECHA_MOVIMIENTO'] = new MongoDate(strtotime(translate_for_mongo('FECHA_MOVIMIENTO'))); 
        
         $parameter['FECHA_ACTA'] = new MongoDate(strtotime(translate_for_mongo('FECHA_ACTA')));
