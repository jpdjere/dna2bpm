...
class mysql_model_061 extends CI_Model {

    function mysql_model_061() {
        parent::__construct();
    ...
    function anexo_data_tmp($anexo, $filename) {
        ...
        /*
         *  id 	TIPO_DE_SOCIO 	CUIT_SOCIO_INCORPORADO 	SOCIO_INCORPORADO 	TIENE_VINCULACION 	
         * CUIT_VINCULADO 	RAZON_SOCIAL_VINCULADO 	TIPO_RELACION_VINCULACION 	PORCENTAJE_ACCIONES 	ES_PARTICIPE 	ES_PROTECTOR 	filename 	idu 	cuit_sgr Ascending 1
        ...
        foreach ($query->result() as $row) {
            ...
            /* STRING */
            $parameter["CUIT_SOCIO_INCORPORADO"] = (string) $row->CUIT_SOCIO_INCORPORADO;
            $parameter["TIENE_VINCULACION"] = (string) $row->TIENE_VINCULACION;
            $parameter["CUIT_VINCULADO"] = (string) $row->CUIT_VINCULADO;
            $parameter["RAZON_SOCIAL_VINCULADO"] = (string) $row->RAZON_SOCIAL_VINCULADO;
            $parameter["TIPO_RELACION_VINCULACION"] = (string) $row->TIPO_RELACION_VINCULACION;
            /* FLOAT */
            $parameter["PORCENTAJE_ACCIONES"] = (float) $row->PORCENTAJE_ACCIONES;
            ...
            $this->save_anexo_061_tmp($parameter, $anexo);
        }
    }

    /* SAVE FETCHS ANEXO 061 DATA */
    ...
    function save_anexo_061_tmp($parameter, $anexo) {
        $parameter = (array) $parameter;
        $token = $this->idu;
        $period = $this->session->userdata['period'];
        $container = 'container.sgr_anexo_061';
        /* TRANSLATE ANEXO NAME */
