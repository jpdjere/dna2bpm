...
//            $criteria = array('_id' => $details[0]['_id']);
    ...
    function info() {
        ...
        $resultData = $this->mongowrapper->db->$container->find($query);
        return $resultData;
    }
    ...
    function search_name($cuit) {
        ...
        $resultData = $this->mongowrapper->padfyj->$container->findOne($query);
    ...
    function search_code($code) {
        ...
        $resultData = $this->mongowrapper->padfyj->codeact->findOne($query);
        return $resultData["DESCRIPCION"];
    }
