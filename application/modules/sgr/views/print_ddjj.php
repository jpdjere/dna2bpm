...
<!--  PERIOD -->
	...
	<p>Por medio de la presente y en carácter de Declaración Jurada, manifiesto que la información contenida en los archivos detallados a
...
<!--  ANEXO 12 -->
		<div class="row">
			<ul>
				<li>Anexo 12 - Garantías Otorgadas		
				<li>Archivo Importado: <u>{f_12}</u>	
				<li>Anexo 12.1 – Garantías con Sistema de Amortización “Otro”</li>
				Archivo Importado:
				<u>{f_121}</u>
				<li>Anexo 12.2 – Cancelaciones Anticipadas de Garantías</li> Archivo
				Importado:
				<u>{f_122}</u>
				<li>Anexo 12.3 – Saldos diarios de Garantías Comerciales, Futuros y
					Opciones, etc.</li> Archivo Importado: {f_123}
				</u>
				<li>Anexo 12.4 - Garantías Reafianzadas</li> Archivo Importado:
				<u>{f_124}</u>
...
<div class="row">
		<ul>
			<li>Anexo 14 - Fondo de Riesgo Contingente</li> Archivo Importado:
			<u>{f_14}</u>
		</ul>	
</div>
...
<div id="T4" class="table_partners">
			<table>
				...
				<tr>
					<th rowspan="3">cantidad de soc. part. deudores al inicio del
						periodo <br>
					</th>
					...
					<th rowspan="3">cantidad de soc. part. deudores al final del
						periodo <br>
					</th>
				</tr>
				<tr>
...
<div class="row">
		<ul>
		<li>Anexo 15 - Inversión del Fondo de Riesgo</li> Archivo Importado:
		<u>{f_15}</u>
	</ul>
</div>
...
<div class="row">
		<ul>
			<li>Anexo 16 - Grado de Utilización del Fondo de Riesgo</li> Archivo
			Importado:
			<u>{f_16}</u>
		</ul>
...
<div class="row">	
		...
		<p>
			<small>(*) El presente Anexo será generado automáticamente por el
				Sistema una vez finalizada la carga de los Anexos 12, 13, 14, 15 y
				16 y a pedido del usuario. Al solicitar su generación, se le abrirán
				dos pantallas, en la primera deberá indicar el monto de las
				comisiones por otorgamiento de garantías devengado durante el
				período informado, en la segunda podrá realizar las observaciones
				particulares que considere pertinentes respecto de la información
				presentada correspondiente al período que se está informando.</small>
		</p>
</div>
