        ...
        <div id="meta_div_2">
            <form  method="post" class="well" id="period_{sgr_period}">
                ...
                <div  class="row-fluid">
                    <div class="span12">
                        <input type="hidden" name="anexo" value="{anexo}" />
                        <div align="center" class="alert alert-info">{rectified_legend}
                            <div class="row-fluid" align="center">
                                
                                
                                <div class="span6"><button name="submit_period" class="btn btn-block btn-success hide_offline" id="bt_save_{sgr_period}"><i class="icon-save"></i>Confirma</button></div>
                                <div class="span6"><a class="btn btn-block btn-danger hide_offline" href="">Cancelar</a></div>  
                            </div><h5> NOTA: Para terminar la rectificación deberá asociar el perido a un Archivo o a "SIN MOVIMIENTO"</h5>
                        </div>                        
                    </div>
                </div>
            </form>
