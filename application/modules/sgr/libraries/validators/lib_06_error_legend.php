...
EXCENTO,INSCRIPTO,MONOSTRIBUTISTA".';
                break;
            case "AH.3": $result_error = '<strong>Columna ' . $code . ' - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Capital y Acciones Suscriptas e Integradas: Se debe chequear en los movimientos históricos que el Socio Incorporado no tenga saldos positivos en ninguna de estas variables en la SGR en la que se está incorporando. ';
                break;
            case "AI.3": $result_error = '<strong>Columna ' . $code . ' - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Capital y Acciones Suscriptas e Integradas: Se debe chequear en los movimientos históricos que el Socio Incorporado no tenga saldos positivos en ninguna de estas variables en la SGR en la que se está incorporando. ';
                break;
            case "AJ.3": $result_error = '<strong>Columna ' . $code . ' - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Capital y Acciones Suscriptas e Integradas: Se debe chequear en los movimientos históricos que el Socio Incorporado no tenga saldos positivos en ninguna de estas variables en la SGR en la que se está incorporando. ';
                break;
            case "AK.3": $result_error = '<strong>Columna ' . $code . ' - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Capital y Acciones Suscriptas e Integradas: Se debe chequear en los movimientos históricos que el Socio Incorporado no tenga saldos positivos en ninguna de estas variables en la SGR en la que se está incorporando. ';
                break;
...
Existen unos tipos de actividad (que están pintados de rojo en el Excel) que por normativa deberían comunicarse con nosotros antes de poder subirlo. Con lo cual, el validador, si descubriera un socio que se quiere incorporar con uno de los códigos pintados en rojo no debería dejar cargarlo y el mensaje a tirarles seria:  ""El tipo de actividad del socio (tal) requiere ser chequeado con la DSyCSGR. Por favor comuníquese con ellos a tales fines. Gracias."" (¿¿¿¿¿????) Esto estaba escrito. Que significa???????????????????".';
            ...
            case "S.1": $result_error = '<strong>Columna S - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Monto 1: OPCIONAL. Si las COLUMNAS R o T tienen datos, esta debe tener datos..';
                break;
            case "S.2": $result_error = '<strong>Columna S - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Monto 1: De ser completado, debe contener caracteres numéricos..';
                break;
...
,DDJJ IMPUESTOS ".';
            ...
            case "V.1": $result_error = '<strong>Columna V - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Monto 2: OPCIONAL. Si las COLUMNAS U o W tiene datos, esta debe tener datos..';
                break;
            case "V.2": $result_error = '<strong>Columna V - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Monto 2: De ser completado, debe contener caracteres numéricos..';
                break;
...
,ESTIMACION ".';
            ...
            case "AB.1": $result_error = '<strong>Columna AB - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Cantidad de Empleados: El campo no puede estar vacío y debe contener caracteres numéricos mayores a Cero..';
                break;
            case "Q.3": $result_error = '<strong>Columna Q - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Código de Actividad: TODAS DEBEN ESTAR VACÍAS.';
                break;
            case "R.4": $result_error = '<strong>Columna R- Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Año/Mes 1: TODAS DEBEN ESTAR VACÍAS.';
                break;
            case "S.4": $result_error = '<strong>Columna S - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Monto 1: TODAS DEBEN ESTAR VACÍAS.';
                break;
            case "T.3": $result_error = '<strong>Columna T- Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Tipo Origen 1: TODAS DEBEN ESTAR VACÍAS.';
                break;
            case "U.4": $result_error = '<strong>Columna U - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Año/Mes 2: TODAS DEBEN ESTAR VACÍAS.';
                break;
            case "V.4": $result_error = '<strong>Columna V - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Monto 2: TODAS DEBEN ESTAR VACÍAS.';
                break;
            case "W.3": $result_error = '<strong>Columna W - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Tipo Origen 2: TODAS DEBEN ESTAR VACÍAS.';
                break;
            case "X.3": $result_error = '<strong>Columna X- Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Año/Mes 3: TODAS DEBEN ESTAR VACÍAS.';
                break;
            case "Y.3": $result_error = '<strong>Columna Y - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Monto 3: TODAS DEBEN ESTAR VACÍAS.';
                break;
            case "Z.3": $result_error = '<strong>Columna Z- Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Tipo Origen 3: TODAS DEBEN ESTAR VACÍAS.';
                break;
            case "AB.2": $result_error = '<strong>Columna AB- Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Cantidad de Empleados: TODAS DEBEN ESTAR VACÍAS.';
                break;
