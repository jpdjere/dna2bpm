...
class Lib_06_error_legend {
    ...
    function return_legend($code, $row, $value) {
        ...
        switch ($code) {
            ...
            case "AM.1":
                $result_error = '(Fila Nro.'. $row .')AM:Carácter de la Cesión:En caso de que en la columna "A" se completen las opciones "INCORPORACION" o "INCREMENTO DE TENENCIA ACCIONARIA" y en la columna AG se complete la modalidad SUSCRIPCION, estas dos columnas deben estar vacías.';
                break;

            case "AM.2":
                $result_error = '(Fila Nro.'. $row .')AM:Carácter de la Cesión:En caso de que en la columna "A" se complete la opción "DISMINUCION DE CAPITAL SOCIAL", estas dos columnas NO PUEDEN ESTAR VACÍAS.';
                break;
            ...
            case "AM.4":
                $result_error = '(Fila Nro.'. $row .')AM:Carácter de la Cesión:De ser completada, debe contener uno de los siguientes parámetros:DISMINUCION DE TENENCIA ACCIONARIA,DESVINCULACION';
                break;
