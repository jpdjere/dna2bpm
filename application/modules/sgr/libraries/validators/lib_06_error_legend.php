...
class Lib_06_error_legend {
    ...
    function return_legend($code, $row, $value) {
        ...
        switch ($code) {
            ...
            case "AL.1": 
                $result_error = '<strong>Columna AL - Fila Nro.'. $row .' - Código Validación '.$code.'</strong><br/>CUIT del Cedente: En caso de que en la columna "A" se completen las opciones "INCORPORACIÓN" o "INCREMENTO DE TENENCIA ACCIONARIA" y en la columna AG se complete la modalidad SUSCRIPCION, estas dos columnas deben estar vacías.';
                break;
            ...
            case "AM.1": 
                $result_error = '<strong>Columna AM - Fila Nro.'. $row .' - Código Validación '.$code.'</strong><br/>Carácter de la Cesión: En caso de que en la columna "A" se completen las opciones "INCORPORACION" o "INCREMENTO DE TENENCIA ACCIONARIA" y en la columna AG se complete la modalidad SUSCRIPCION, estas dos columnas deben estar vacías.';
                break;
