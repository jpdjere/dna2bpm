    ...
    function return_legend($code, $row, $value) {
        ...
        switch ($code) {
            ...
            case "F.1":
                ...
                break;
            case "F.2":
                $result_error = '<strong>Columna F - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/> Si en la columna A ingresaron la opción D o K, debe permitir valores entre -20000000 y 99999999999, con formato numérico y aceptar hasta dos decimales.';
                break;
            case "G.1":
                ...
                break;
            case "G.2":
                $result_error = '<strong>Columna G - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Si y solo si la opción INCISO_ART_25 (columna A) es H, debe permitir que el CUIT Entidad depositaria sea 30528994012 - MERCADO A TERMINO DE ROSARIO SA, además de los establecidos en el listado OPCIONES DE INVERSIÓN.';
                break;
            case "H.1":
            ...
            case "I.1":
                ...
                break;
            case "I.B.1":
                $result_error = '<strong>Columna I - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Si en la columna A ingresaron la opción D , K o H, debe permitir valores entre -20000000 y 99999999999, con formato numérico y aceptar hasta dos decimales.';
                break;
            case "I.2":
