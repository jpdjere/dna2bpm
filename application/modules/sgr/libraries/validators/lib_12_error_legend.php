    ...
    function return_legend($code, $row, $value) {
        switch ($code) {           
            ...
            case "I.3":
                ...
                break;
            case "I.4":
                $result_error = '<strong>Columna I - Fila Nro.'. $row .' - Código Validación '.$code.'</strong><br/>Si la Columna D se completó con alguna de las siguientes Opciones:GGFPB. deberá tener el siguiente formato: $, 3 Letras, 9 Números. Ej. $CUA000000001';
                break;
            case "J.1":
