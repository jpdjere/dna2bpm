    ...
    function return_legend($code, $row, $value) {
        ...
        switch ($code) {
            case "A.1":
                ...
                break;
            case "B.1":
                $result_error = '<strong>Columna B - Fila Nro.'. $row .' - Código Validación '.$code.'</strong><br/>Formato de número. Acepta hasta dos decimales.';
                break;
            case "C.1":
            ...
            case "E.1":
                ...
                break;
            case "F.1":
                $result_error = '<strong>Columna F - Fila Nro.'. $row .' - Código Validación '.$code.'</strong><br/>Formato de número. Acepta hasta dos decimales.';
                break;
        }
        return $result_error;
    }
