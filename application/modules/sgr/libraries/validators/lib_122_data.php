                    ...
                    if ($return) {
                        ...
                        foreach ($warranty_info as $order_number) {
                            ...
                            if ($currency == 2) {
                                ...
                                if ($fix_ten_cents) {
                                    $code_error = "F.2.B";
                                    $result = return_error_array($code_error, $parameterArr[$i]['row'], money_format_custom($a) . ' Monto disponible para el Nro. Orden  = ' . $order_number[5218] . '  (' . $amount_warranty . '/' . $dollar_quotation_origin . '*' . $dollar_quotation_period . ' = ' . money_format_custom($new_dollar_value) . ' )');
                                    array_push($stack, $result);
                                }
                            } else {
