    ...
    function return_legend($code, $row, $value) {
        ...
        switch ($code) {
            ...
            case "I.1":
                ...
                break;
            case "I.B.1":
                $result_error = '<strong>Columna I - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Si en la columna A ingresaron la opción D o K, debe permitir valores entre -500000 y 99999999999, con formato numérico y aceptar hasta dos decimales.';
                break;
            case "I.2":
