...
class Lib_141_error_legend {
    ...
    function return_legend($code, $row, $value) {
        ...
        switch ($code) {
            case "A.1":
                $result_error = '<strong>Columna A - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Debe tener 11 caracteres sin guiones. Debe corresponder a una CUIT Válida';
                break;
            case "A.2":
            ...
            case "A.5":
                ...
                break;
            case "B.1":
                $result_error = '<strong>Columna B - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Si se detecta que el CUIT está informando en el ANEXO 12.5, debe tener formato número y aceptar números enteros mayores a Cero.<br>De lo contrario, debe estar vacío.';
                break;
            case "C.1":
                $result_error = '<strong>Columna C - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>De completarse, debe tomar valor numérico mayor a cero y aceptar hasta dos decimales.';
                break;
            case "D.1":
                $result_error = '<strong>Columna D - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>De completarse, debe tomar valor numérico mayor a cero y aceptar hasta dos decimales.';
                break;
            case "E.1":
                $result_error = '<strong>Columna E - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>De completarse, debe tomar valor numérico mayor a cero y aceptar hasta dos decimales.';
                break;
            case "F.1":
                $result_error = '<strong>Columna F - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>De completarse, debe tomar valor numérico mayor a cero y aceptar hasta dos decimales.';
                break;
            case "G.1":
            ...
            case "H.1":
                ...
                break;
            case "I.1":
                $result_error = '<strong>Columna I - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Debe validar que si en el proceso de importación detecta que el CUIT informado en la Columna A tiene saldos de deuda positivos (Saldo Calculado por el Sistema sobre la información histórica de los movimientos del FDR Contingente informados mediante ANEXO 14), esta columna deberá estar completa.';
                break;
            case "I.2":
                $result_error = '<strong>Columna I - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>De estar completo, debe tomar alguno de los siguientes parámetros:"1","2","3","4","5".';
                break;
        }
        return $result_error;
    }
