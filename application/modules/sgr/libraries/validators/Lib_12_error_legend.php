    ...
    function return_legend($code, $row, $value) {
        switch ($code) {
            case "A.1":
                ...
                break;
            case "A.2":
                $result_error = '<strong>Columna A - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>El campo no puede contener puntos ni comas. Si debe permitir números, guiones ( - ), barras (/), letras o combinación de ambas.';
                break;
            case "B.1":
            ...
            case "F.1":
                ...
                break;
            case "F.2":
                $result_error = '<strong>Columna F - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Si la Columna D se completó con la opción GFCPD, la moneda de origen sólo podrá ser PESOS ARGENTINOS".';
                break;
            case "G.1":
            ...
            case "K.3":
                ...
                break;
             case "K.4":
                $result_error = '<strong>Columna K - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>El CUIT del acreedor informado no es válido para ese tipo de garantía';
                break;
             case "K.5":
            ...
            case "M.2":
                ...
                break;
            case "N.1":
                $result_error = '<strong>Columna N - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Debe contener uno de los siguientes parámetros: "FIJA"/"LIBOR"/"BADLARPU" (Badlar Bancos Públicos)/"BADLARPR" (Badlar Bancos Privados)/"TEC"/"TEBP"/"BNA"/"50%BNA".';
                break;
            case "O.1":
                $result_error = '<strong>Columna O - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Debe tomar valores entre -1 y -50 o entre 1 y 50 (es decir, no puede tomar valores entre -1 y 1).';
                break;
            case "O.2":
            ...
            case "T.1":
                ...
                break;
            case "T.2":
                $result_error = '<strong>Columna T - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>T - Fila Nro.' . $row . ' - Código Validación ' . $code . '</strong><br/>Si el período informado es anterior al 2014 el campo debe estar vacío.';
                break;
