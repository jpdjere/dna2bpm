        ...
        for ($i = date("Y"); $i > 2009; $i--) {
            ...
            foreach ($processed as $file) {
                ...
                if ($file_origen == "forms2") {
                    ...
                    $download = anchor('sgr/index/' . $asset . '/' . $anexo . '/' . $file_filename, ' <i class="fa fa-download" alt="Descargar"></i>', array('class' => 'btn btn-primary' . $disabled_link));
                    ...
                    $download = anchor('sgr/index/' . $asset . '/' . $anexo . '/' . $file_filename, ' <i class="fa fa-download" alt="Descargar"></i>', array('target' => '_blank', 'class' => 'btn btn-primary' . $disabled_link));
