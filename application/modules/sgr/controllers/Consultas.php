...
function vinculados($data) {


        
        $vinculados_info = $this->consultas_model->buscar_cuits_vinculados($data);

        $rtn = $this->parser->parse('consultas/vinculados_table_head_view', $data, true, true);  
