...
<span class="hidden widget_url">{widget_url}</span>
    <div class="inner">
        ...
        <div class="col-md-12">
        <h4>Buscador</h4>
        <form class="form-extra" accept-charset="utf-8" method="post" action="{base_url}fondyf/buscar/pp">
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="list-unstyled" style="margin-top:10px">
                    <li>
                        <a href="{base_url}fondyf/listar_pp" class="load_tiles_after">Solicitudes</a>
                        (<a href="{base_url}fondyf/listar_pp/xls"><icon class="fa fa-download"></icon> xls</a>)
                    </li>
                    <li>
                        <a href="{base_url}fondyf/listar_pde" class="load_tiles_after">Proyectos</a>
                        <span class="pull-right>">
                            (<a href="{base_url}fondyf/listar_pde/xls"><icon class="fa fa-download"></icon> xls</a>)
                        </span>
                    </li>
                </ul>
          </div> 
