...
var SearchEmpresa = function(me) {
    ...
    if (me.isValid() && me.value.length == 13 && !EmpresaStore.isLoading()) {
        ...
        if (index >= 0) {
            ...
            record = Ext.create('EmpresaModel', {
                1695:val
            });
            EmpresaForm.loadRecord(record);
            EmpresaForm.setLoading(false);
...
var EmpresaForm = Ext.create('Ext.form.Panel', {
    ...
    },mymap,
    {
        ...
        },
        {
            ...
            items: [
            {
                boxLabel: 'Sucursal Empresa Extranjera', 
                name: '1694', 
                inputValue: 14
            },
            ...
            {
                boxLabel: 'Unipersonal', 
                name: '1694', 
                inputValue: 8
            },

            {
                boxLabel: 'Sociedad de Responsabilidad Limitada (S.R.L)', 
                name: '1694', 
                inputValue: 2
            },

            {
                boxLabel: 'Sociedad De Hecho (S.H)', 
                name: '1694', 
                inputValue: 7
            },

            {
                boxLabel: 'Sociedad Anonima (S.A)', 
                name: '1694', 
                inputValue: 1
            },

            {
                boxLabel: 'Cooperativa', 
                name: '1694', 
                inputValue: 12
            },

            {
                boxLabel: 'Sociedad en Comandita', 
                name: '1694', 
                inputValue: 24
            }
            ]
    ...
    },
    {
        ...
        },
        {
            ...
            items: [
            {
                boxLabel: 'A otras provincias', 
                name: '1716', 
                inputValue: '3'
            },

            {
                boxLabel: 'Dentro de la provincia', 
                name: '1716', 
                inputValue: '1'
            },
