            ...
            <div class="span6">
                    <div class="input-prepend input-append">
                     <span class="add-on "><i class="icon-calendar"></i></span>
                        <input  type="text"  name="dia" class="datepicker input-small" placeholder=".span6">
...
<!--            
           <div class="input-prepend span4">
            <span class="add-on "><i class="icon-calendar"></i></span>
               <input  type="text"  name="dia" class="datepicker" placeholder=".span6">
           </div>
            <select  name="hora" class="span2">
            <option>01</option>
            <option>02</option>
            <option>03</option>
            <option>04</option>
            ...
            <select  name="minutos" class="span2" >
            <option selected="selected" >00</option>
            <option>05</option>
            <option>10</option>
            <option>15</option>
