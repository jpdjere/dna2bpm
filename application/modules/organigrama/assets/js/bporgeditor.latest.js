...
primitives.orgeditor.Controller.prototype._createLayout = function () {
    ...
    contentString += '<div style="width:120px;" name="options-button">Options</div>';
    //----Json button
    contentString += '<div style="width:120px;" id="json-button" name="json-button">JSON</div>';
    //----save button
    contentString += '<div style="width:120px;" id="save-button" name="save-button">SAVE</div>';
...
primitives.orgeditor.Controller.prototype._createWidgets = function () {
	...
	this.element.find("[name=save-button]").button().click(function () { self._onSaveButtonClick(); });
...
primitives.orgeditor.Controller.prototype._onSaveButtonClick = function () {
	var self = this,
		index,
		len,
		fieldToClone,
	...
	$.ajax({
		'url':globals.module_url+'save/'+globals.idorg,
		'method':'post',
