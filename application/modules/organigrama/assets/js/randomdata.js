...
function GetNextPhoto() {
	...
	return "organigrama/assets/images/photos/" + photos[photoIndex] + ".png";
}
...
function getMatrixedLeaves() {
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        image: "organigrama/assets/images/photos/a.png",
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        image: "organigrama/assets/images/photos/z.png",
    ...
    items.push(new primitives.orgdiagram.ItemConfig({
        ...
        image: "organigrama/assets/images/photos/y.png",
	...
	for (var groupKey in groups) {
		...
		var manager = new primitives.orgdiagram.ItemConfig({
		    ...
		    image: "organigrama/assets/images/photos/" + groupKey.toLowerCase() + ".png",
