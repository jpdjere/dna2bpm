<div class="tour-step tour-step-three box box-primary {class}">
    <span class="hidden json_url">{json_url}</span>
<div class="box-header" style="cursor: move;">
  <div style="padding-left: 0px" class="col-md-7 col-sm-8 col-xs-12">
   <h3 class="pull-left box-title"><i class="fa fa-bar-chart-o"></i> {title}</h3>
    </div>
  <div class="col-md-5 col-sm-4 col-xs-12">
        <div style="margin-top: 12px;" class="box-tools">
            <p style="font-size: 12px; padding-right: 5px; border-right: 1px solid #f4f4f4 " class="pull-left"><i class="fa fa-circle-o referencia"></i> Ingresada</p>
            <p style="font-size: 12px; padding-left: 5px;" class="pull-left"><i class="fa fa-circle-o referencia2"></i> Evaluada</p>
        </div>
    </div>
    </div>
    <div class="box-body">
